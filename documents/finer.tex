...
Organization versus Product. For example, consider the two related but distinct meanings of Youtube in "Katsoa videoita Youtubesta" ja "Youtube on Googlen omistama yhtiš".

Organization versus Location. For example, consider India as a geographical location in "" and India as a governmental organization in "".

Large number of temporal expressions. The temporal expressions are 
