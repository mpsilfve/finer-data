...
The annotation was performed iteratively by a group of three people as follows. First, the group created an initial annotation guideline based on literature. Then, the material was annotated using this guideline. The annotation was performed by a single annotator. Subsequently, the guideline and annotation were revised by the group for two more iterative passes over the data set. The annotation was performed over a span of one year.


in total four annotators. In other words, the annotation and annotation guideline were defined and improved during multiple passes over the data set. The annotation was performed over a span of one year.
