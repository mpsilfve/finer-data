...
\pararaph{Organization versus Product}. For example, consider the two related but distinct meanings of Youtube in "Katsoa videoita Youtubesta" ja "Youtube on Googlen omistama yhtiš".

\pararaph{Organization versus Location}. For example, consider India as a geographical location in "" and India as a governmental organization in "".

\pararaph{Explicit naming}. For example, consider "Nokia N1-niminen puhelin".
