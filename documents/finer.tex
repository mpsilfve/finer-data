...
The text material is extracted from the archives of Digitoday, a Finnish online technology news source. The text covers a variety of topics related to information technology, including business, data, mobile, science and technology, information security, work and career, gadgets, and society.  
...
The markable temporal expressions are adopted from the TIMEX3 annotation guideline specified for the SemEval-2010: Tempeval-2 evaluation task for English \citep{verhagen2010}.\footnote{The guideline is available at \url{http://www.timeml.org/tempeval2/tempeval2-trial/guidelines/timex3guidelines-072009.pdf}} The guideline specifies the following temporal expressions (timexes): 
...
In what follows, we discuss how to adopt the above TIMEX3 scheme to Finnish.

First, according to English specifications, the expressions can not begin with a Preposition or a clause of any type. Thus, the following are not allowed as English TIMEX3 expressions: before Thursday, in the morning, after the strike ended on Thursday, over the last 2 years. Meanwhile, each of the previous contain partial markable expressions: before \textbf{Thursday}, in \textbf{the morning}, after the strike ended on \textbf{Thursday}, over \textbf{the last 2 years}. As for Finnish, we extend this rule to apply for Postpositions and well as Prepositions. Thus, the following are not allowed as Finnish TIMEX3 expressions: ennen torstaita (before Thursday), torstain j\"alkeen (after Thursday). However, in case the 


Note though that each of these expressions do include TIMEX3 extents that should be marked: before Thursday, in the morning, after the strike ended on Thursday, over the last 2 years.


the full extent of a TIMEX3 cannot be a Prepositional Phrase (so that the extent begins with a Preposition) or a clause of any type (for example, the expression cannot start with a subordinating conjunction). Thus, the following are not allowed as TIMEX3 extents: before Thursday, in the morning, after the strike ended on Thursday, over the last 2 years. Note though that each of these expressions do include TIMEX3 extents that should be marked: before Thursday, in the morning, after the strike ended on Thursday, over the last 2 years.
