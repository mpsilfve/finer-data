...
%Similarly, the low F1-score of 71.55 obtained for product names stems from a difficulty of differentiating product names from organization and person names . However, these difficulties are not reflected in the F1-score obtained for organization names since the organization name class is disctinctly the largest and is elevated by a relatively few, easily recognizable company names, such as ''Apple'' and ''Google''.  
...
Third, dates and titles appear to be the easiest classes to learn. This is somewhat expected since they form the most restricted classes according to the annotation guideline discussed in Section \ref{sec: named entities}.
