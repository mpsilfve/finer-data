...
Named entity recognition (NER) is a fundamental information extraction task, in which the aim is to locate and classify expressions in text to pre-defined classes, such as persons, locations, and organizations. 
