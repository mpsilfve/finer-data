...
First, as for the conventional enamex classes (organization, location, and person names), we note that, perhaps surprisingly, the person names were most challenging to learn. While organization and location names yielded F1-scores of 86.18 and 87.55, respectively, the person names yielded a much lower F1-score of 72.75. The difficulty of learning the person names might (or could this be verified?\fixme{}) stem from the fact that the corpus contains a considerable amount of news discussing global events and people. In future work, improving the recognition of person names would require a more careful design of gazetteers including not only Finnish and English but additionally Chinese, Indian, and Japanese names. 

Second, it appears that product names are challenging to learn compared to, for example, organizations and locations. This is somewhat expected since comprehensive gazetteers of product names were found difficult to create. In addition, compared to organizations and locations, product names are more versatile given that they can contain version numbers and version names according to the annotation guideline discussed in Section \ref{sec: named entities} which makes learning more tedious.
