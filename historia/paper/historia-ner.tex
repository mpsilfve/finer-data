...
In previous work, the non-nested annotation has been the prevalent annotation strategy, apart from a few expections \citep{byrne2007,benikova2014}. This is probably due to the added annotation effort required by the nested approach. 
