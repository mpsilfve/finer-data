...
''Hirwensalmen ja Anttolan pitäjät''
...
The annotation process was performed iteratively by in total three annotators. In other words, the annotation and annotation guideline were defined and improved during multiple passes over the data set. The annotation was performed over a span of six months.
