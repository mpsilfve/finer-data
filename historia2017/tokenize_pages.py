...
stop_list_abbv_names = ['Berl.', 'Em.', 'Vict.', 'Pert.', 'Ferd.', 'Edw', 'And.', 'Gabr.', 'Edw.', 'Didr.', 'Jon.', 'Koloss.', 'Lut.', 'Erikinp.', 'Ont.', 'Jes.', 'Hebr.', 'Hepr.', 'Kol.', 'Matth.', 'Es.', 'Alfr.', 'Job.', 'Ap.', 'Luk.', 'Tim.', 'Rom.', 'Mark.', 'Math.', 'Es.', 'Kun.', 'Luuk.', 'Moos.', 'Mos.', 'Tess.', 'Kor.', 'Hab.', 'Piet.', 'Wilh.', 'Joh.', 'Walfr.', 'Kris.', 'Magn.', 'Fr.', 'Pr.', 'Andr.', 'Gust.', 'Art.', 'Ad.', 'Th.', 'Chr.', 'Ch.', 'Fredr.', 'Wibl.', 'Hbl.', 'Konr.', 'Aug.', 'Wald.', 'Rob.', 'Leon.', 'Kust.', 'Reinh.', 'Piet.', 'Tulliporttik.', 'Zach.', 'Reinh.', 'Alex.', 'Ludw.', 'Walt.', 'Wilhelminp.']
